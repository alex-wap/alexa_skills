...
var CARD_TITLE = "America Flash Cards"; 
...
function getWelcomeResponse(callback) {
    ...
    var sessionAttributes = {},
        ...
        speechOutput = "I will ask you " + GAME_LENGTH.toString()
            + " questions about countries in North and South America, try to guess which continent it belongs to. Just say the answer. Let's begin. ",
    ...
    if (!gameInProgress) {
        ...
        if (currentQuestionIndex == GAME_LENGTH - 1) {
            ...
            speechOutput += speechOutputAnalysis + "You got " + currentScore.toString() + " out of "
                + GAME_LENGTH.toString() + " questions correct. Thank you for learning about North and South America with Alexa!";
            callback(session.attributes,
